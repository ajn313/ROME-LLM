//======================================================================
// aes_dec_round_tb.v  (Verilog-2001 only)
// Testbench for AES decryption round:
//   state_out = InvMixColumns( AddRoundKey( InvSubBytes( InvShiftRows(state_in) ), round_key ) )
//
...
//   aes_inv_shift_rows -> aes_inv_sub_bytes -> aes_add_round_key -> aes_inv_mix_columns
//======================================================================

`timescale 1ns/1ps

module aes_dec_round_tb;
  ...
  // Golden reference: InvShiftRows -> InvSubBytes -> AddRoundKey -> InvMixColumns
  ...
  aes_add_round_key u_ref_add_round_key (
    ...
    .round_key (round_key),
    .state_out (ref_ark_out)
  );

  aes_inv_mix_columns u_ref_inv_mix_columns (
    .state_in  (ref_ark_out),
    .state_out (ref_out)
  );
