...
module aes_inv_sub_bytes_tb;
  ...
  initial begin
    ...
    // ---------------------------------------------------------------
    // Test 1: All 0x63 -> all 0x00 (since InvS(63)=00)
    // ---------------------------------------------------------------
    run_test(
    ...
    // Inputs:  63 7c 77 7b f2 6b 6f c5 30 01 67 2b fe d7 ab 76
    ...
    //   InvS(ed)=53, InvS(16)=ff, InvS(ca)=10, InvS(84)=7c,
    ...
    // ---------------------------------------------------------------
    // Test 4: Another lane-mix / visibility pattern (inverse of prior TB Test 4)
